            ...
            <div class="col-md-12 col-md-offset-0 text-left">
              <div class="row row-mt-15em">
                <div class="col-md-12 mt-text animate-box form-wrap" data-animate-effect="fadeInUp">
                  <h1>Pilih Waktu Penerbangan</h1>  
                  <div class="tab">
                    <div class="tab-content">
                      <div class="tab-contect-inner active">
                    ...
                    <tbody>
                      <?php $no=1;foreach ($cari as $key): ?>
                      <tr>
                        <td><?php echo $no++; ?></td>
                        <td><?php echo $key->depart_at ?><br><?php echo $key->date ?></td>
                        <td><?php echo $key->rute_from ?></td>
                        <td><?php echo $key->rute_to ?></td>
                        <td>Rp. <?php echo $key->price ?></td>
                        <td><a href="<?php echo base_url('welcome/pesan/'. $key->id); ?>" class="btn btn-primary">Pesan</a></td>
                      </tr>
                    <?php endforeach ?>
                  </tbody>
                </table>
