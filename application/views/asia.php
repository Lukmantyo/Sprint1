				...
				<div class="col-xs-8 text-right menu-1">
					<ul>
						...
						<li class="has-dropdown">
							<a href="#">Travel</a>
							<ul class="dropdown">
								<li><a href="<?php echo base_url(); ?>welcome/eropa">Europe</a></li>
								<li><a href="<?php echo base_url(); ?>welcome/lokal">Lokal</a></li>
								<li><a href="<?php echo base_url(); ?>welcome/lainnya">Lainnya</a></li>
							</ul>
						</li>
						<li><a href="<?php echo base_url(); ?>welcome/maskapai">Maskapai</a></li>
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<h2>Berlibur ke daerah favorit anda !</h2>
					<p>Pilih dan pesan destinasi libur favorit anda !</p>
				</div>
			</div>
			<div class="row">

				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="<?php echo base_url(); ?>gudang/traveler/images/img_4.jpg" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="<?php echo base_url(); ?>gudang/traveler/images/img_4.jpg" alt="Image" class="img-responsive">
						</figure>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="<?php echo base_url(); ?>gudang/traveler/images/img_5.jpg" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="<?php echo base_url(); ?>gudang/traveler/images/img_5.jpg" alt="Image" class="img-responsive">
						</figure>
						<div class="fh5co-text">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="<?php echo base_url(); ?>gudang/traveler/images/img_6.jpg" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="<?php echo base_url(); ?>gudang/traveler/images/img_6.jpg" alt="Image" class="img-responsive">
						</figure>
						<div class="fh5co-text">
							<h2>China, Asia</h2>
							<p>Far far away, behind the word mountains, far from the countries Vokalia..</p>
