				...
				<div class="col-md-12 col-md-offset-0 text-left">
					<div class="row row-mt-15em">
						...
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small">Jangan Malu Bertanya</span>
							<h1>Kontak Kami</h1>	
						</div>
			...
			<div class="row">
					...
					<form action="#">
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" id="email" class="form-control" placeholder="E-mail Anda">
							</div>
						</div>

						<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="subject">Judul Pesan</label>
								<input type="text" id="subject" class="form-control" placeholder="Judul Pesan Anda">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<textarea name="message" id="message" cols="30" rows="10" class="form-control" placeholder="Tuliskan Pesan Anda"></textarea>
							</div>
						</div>
				...
				<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="gtco-contact-info">
						...
						<ul>
							<li class="address">D.I Pandjaitan Street, <br> Telkom Engineering School</li>
							<li class="phone"><a href="tel://1234567920">+ 1235 2355 98</a></li>
							<li class="email"><a href="mailto:info@yoursite.com">lukmantyo26@gmail.com</a></li>
							<li class="url"><a href="http://GetTemplates.co">localhost/tiketpesawat</a></li>
						</ul>
					</div>
