					...
					<ul>
						...
						<li class="has-dropdown">
							...
							<ul class="dropdown">
								...
								<li><a href="<?php echo base_url(); ?>welcome/asia">Asia</a></li>
		...
		<div class="gtco-container">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="<?php echo base_url(); ?>gudang/traveler/images/img_1.jpg" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="<?php echo base_url(); ?>gudang/traveler/images/img_1.jpg" alt="Image" class="img-responsive">
						</figure>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="<?php echo base_url(); ?>gudang/traveler/images/img_2.jpg" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="<?php echo base_url(); ?>gudang/traveler/images/img_2.jpg" alt="Image" class="img-responsive">
						</figure>
						<div class="fh5co-text">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="<?php echo base_url(); ?>gudang/traveler/images/img_3.jpg" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="<?php echo base_url(); ?>gudang/traveler/images/img_3.jpg" alt="Image" class="img-responsive">
						</figure>
						<div class="fh5co-text">
